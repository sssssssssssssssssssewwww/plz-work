    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be cool! A member of the United Association just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the United Association!",
                    reply_to_message_id=reply,
                )
                return
...
WELC_HELP_TXT = (
    "Your group's welcome/goodbye messages can be personalised in multiple ways made by @teleunitedbots. If you want the messages"
...
*Welcome markdown:* 
 ❍ /welcomehelp*:* view more formatting information for custom welcome/goodbye messages @teleunitedbots.
"""
