...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD TO YOUR GROUP ➕️", url="https://t.me/Real_worker_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="Updates", url="https://t.me/teleunitedbots"),
        InlineKeyboardButton(text="Support", url="https://t.me/tele_united_bots"),
    ],
    [
        InlineKeyboardButton(
...
You Can donate to this bot via [dm me](paypal.me/lead_developer) Or [share bot](https://t.me/friendly_zbot)"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            "I'm awake already!\n<b>Haven't die since:</b> <code>{}</code>".format(
                uptime
            ),
...
def groupmenter_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "groupmenter":
        query.message.edit_text(
            text=""" 🤖 I'm *Sam*, a powerful group management bot built to help you manage your group easily.
...
❍ I check for admins' permissions before executing any command and more stuffs
                 ...
                 Here is the [💾Repository](https://telegra.ph/file/5f12d4ccf9ad5df413e2f.mp4).
                 If you have any question about Group Menter, let us know at @tele_united_bots.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Sam*
                 \nHere is the [Source Code](https://telegra.ph/file/5f12d4ccf9ad5df413e2f.mp4) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
